    ...
    inputs.flake-parts.lib.mkFlake { inherit inputs; } (top: {
      ...
      flake.overlays.emacs =
        ...
        in
        {
          ...
          emacsPackagesOverride =
            emacsPackages:
            let
              optionalOverrideAttrs =
                name: fn:
          ...
          emacsAnyPackages =
            emacs-pkg:
            (prev.emacsPackagesFor emacs-pkg).overrideScope (
              eself: esuper:
              let
                blockAll = [
                  "docker"
                ...
                overridePkgs =
                  emacsPkgs: block:
                  filterAttrs (name: _: !(elem name block) && !(elem name blockAll)) (
